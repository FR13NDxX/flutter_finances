...
///
/// Built on 2024-08-02 at 15:30 UTC
...
class _StringsRu implements Translations {
	...
	@override String get save => 'Сохранено';
...
class _StringsLoginRu implements _StringsLoginEn {
	...
	@override String get fail => 'Ошибка';
}
...
extension on _StringsRu {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'hello': return ({required Object name}) => 'Привет ${name}';
			case 'save': return 'Сохранено';
			case 'login.success': return 'Успешно';
			case 'login.fail': return 'Ошибка';
			default: return null;
		}
	}
}
